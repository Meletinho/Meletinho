...
Sou graduando em **Análise e Desenvolvimento de Sistemas** na UCSal e atuo de ponta a ponta (End-to-End). Minha missão é transformar problemas complexos de negócios em código limpo, escalável e seguro, transitando entre ecossistemas robustos como **Java/Spring Boot** e **Node/NestJS**.
...
### 🏋️‍♂️ Nohalt - Plataforma de Gestão (PWA) para Studio Nohalt
**Tech:** NestJS, TypeScript, Supabase, PostgreSQL
* Desenvolvimento de backend modular utilizando **NestJS** com arquitetura baseada em módulos (controllers, services, DTOs e entities).
